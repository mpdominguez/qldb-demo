...
def lambda_handler(event, context):
    ...
    #Test With = {"text": "{'id_transaction': 2233, 'authorization_code': 'AXJFDSF2434', 'dev_reference': 'FDKSJFHD234', 'currency': 'GBP', 'amount': 12345, 'date_in': `2019-10-01T12:00:00Z`}"}

    statement = 'INSERT INTO transactions ' + event['text']
